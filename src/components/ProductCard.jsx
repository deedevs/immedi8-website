...
const Card = ({ image, title, description }) => {
  ...
  return (
    ...
    >
      ...
      />
      {isHovered && (
        <div className="absolute top-0 left-0 h-full w-full p-4 bg-gradient-to-r from-red-600 to-[#1c2e4a] flex flex-col justify-center items-center opacity-0 transition-all duration-[1s] ease-in-out text-white hover:opacity-[1]">
